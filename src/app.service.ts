          ...
          <section id="settings-section" class="surface-panel mb-4">
            ...
            <form class="p-4 pt-0" @submit.prevent="saveGlobalSettings()">
              <div class="row g-3">
                ...
                <div class="col-md-6"><label class="form-label" for="global-worker-concurrency">Worker concurrency</label><input id="global-worker-concurrency" type="number" min="1" max="${MAX_WORKER_CONCURRENCY}" class="form-control" x-model.number="settingsForm.workerConcurrency" required /></div>
                <div class="col-md-6"><label class="form-label" for="global-clone-timeout">Git clone timeout (ms)</label><input id="global-clone-timeout" type="number" min="1" max="${MAX_TIMER_MS}" class="form-control" x-model.number="settingsForm.cloneTimeoutMs" required /></div>
                <div class="col-12"><label class="form-label" for="global-custom-prompt">Custom prompt</label><textarea id="global-custom-prompt" class="form-control" rows="5" maxlength="100000" x-model="settingsForm.customPrompt"></textarea></div>
            ...
            <form class="p-4 pt-2" @submit.prevent="saveRepositorySettings()">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6"><label class="form-label" for="repository-timeout">Timeout (empty = inherit)</label><input id="repository-timeout" type="number" min="1" max="${MAX_TIMER_MS}" class="form-control" x-model="repositoryForm.timeoutMs" /></div>
                <div class="col-12"><label class="form-label" for="repository-custom-prompt">Custom prompt (empty = inherit)</label><textarea id="repository-custom-prompt" class="form-control" rows="4" maxlength="100000" x-model="repositoryForm.customPrompt"></textarea></div>
