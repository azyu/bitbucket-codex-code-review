...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    "detail.cliVersion": "Codex CLI",
    "detail.mergeBase": "diff 기준 merge-base",
    "detail.prompt": "입력 프롬프트",
    "detail.promptShow": "펼치기",
    "detail.promptHide": "접기",
    "detail.promptMissing": "이 실행에는 기록된 프롬프트가 없습니다.",
    ...
    "secret.status.setGlobally": "전역에 설정됨",
    "secret.status.setOnRepository": "이 저장소에 설정됨",
  ...
  en: {
    ...
    "detail.cliVersion": "Codex CLI",
    "detail.mergeBase": "Diff merge-base",
    "detail.prompt": "Input prompt",
    "detail.promptShow": "Show",
    "detail.promptHide": "Hide",
    "detail.promptMissing": "No prompt was recorded for this run.",
    ...
    "secret.status.setGlobally": "set globally",
    "secret.status.setOnRepository": "set on this repository",
